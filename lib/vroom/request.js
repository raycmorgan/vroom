...
Request.prototype = {
  ...
  puts: function() {
    if (!this.hasSentHeader) {
      LOG.debug("Auto sending headers because 'puts' was called before 'sendHeader'.");
      this.sendHeader();
    }
  ...
  ejs: function(name, opts) {
    ...
    var r = this;
    var path = (this.application.rootDir || ".") + "/" + name + ".html.ejs";
    ...
    EJS.render(renderPromise, path, this);
