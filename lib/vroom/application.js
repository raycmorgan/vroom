...
exports.Application.prototype = {
  ...
  requestHandler: function(request) {
    try {
      ...
      if (!this.callExceptionHandler(request)) {
      ...
      if (this.mounted[i].root.exec(request.path)) {
        ...
        try {
          ...
          if (e.status) {
            ...
            return this.callExceptionHandler(request);
          } else {
            throw(e);
          }
        }
  ...
  callExceptionHandler: function (request) {
    if (this.exceptionHandler && this.exceptionHandler[request.status]) {
      var ret = this.exceptionHandler[request.status].call(request);
      if (!request.finished && typeof(ret) == "string") {
        finishRequest(request, ret);
      }
      return true;
